...
def test_theis_off():
    ...
    ml = ttim.ModelMaq(kaq=50, z=[10, 0], Saq=S / 10, tmin=1e-4, tmax=10)
    ttim.Well(ml, 0, 0, rw=0.3, tsandQ=[(0, Q), (5, 0)])
    ml.solve()
    h2 = ml.head(r, 0, t)[0]
...
def test_theis_Qr():
    ...
    ml = ttim.ModelMaq(kaq=50, z=[10, 0], Saq=S / 10.0, tmin=1e-4, tmax=10)
    ttim.Well(ml, 0, 0, rw=0.3, tsandQ=[(0, Q)])
    ml.solve()
