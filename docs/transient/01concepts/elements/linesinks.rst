...
1. :class:`~timflow.transient.linesink.River` is a line-sink for which the head is specified
   along the line-sink.

2. :class:`~timflow.transient.linesink.RiverString` is a string of head-specified line-sinks
